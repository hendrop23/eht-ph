                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            ...
                                            @endforeach
                                            @php
    $encryptedId = Crypt::encryptString((string) $data->id);
    $shortEncryptedId = substr($encryptedId, 0, 10); // Buat ID singkat untuk tampilan
@endphp

<!-- Tampilkan shortEncryptedId di URL atau di elemen lain -->
<a href="#" class="btn btn-info" id="view-document" data-encrypted-id="{{ $encryptedId }}">
    <i class="voyager-eye"></i> View Document ({{ $shortEncryptedId }})
</a>

<!-- Hidden input to store the encryptedId -->
<input type="hidden" id="encrypted-id" value="{{ $encryptedId }}">
